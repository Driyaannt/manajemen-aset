...
import 'package:manajemen_aset/pages/history_asset/widgets/dalam_proses_card.dart';
import 'package:manajemen_aset/service/database.dart';

import '../history_page.dart';
import 'dalam_proses.dart';

class GetDataDalamProses extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: StreamBuilder(
        stream: DalamProses()
            .listDalamProses(docPembangkit, docJpp, jenisAset, docAset),
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      // tambah tanggal mulai pengerjaan
                      Navigator.push(
                        context,
                        MaterialPageRoute(
...
class RiwayatDalamProses extends StatelessWidget {
  const RiwayatDalamProses({Key? key, required this.controller})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: StreamBuilder(
        stream: DatabaseService().historyUserProses(),
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            return const Text('Something went wrong');
          } else if (snapshot.hasData || snapshot.data != null) {
