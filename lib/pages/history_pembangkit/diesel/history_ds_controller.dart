...
import '../../../models/report_ds.dart';
import '../../../network/base_url_controller.dart';

class HistoryDsController extends GetxController
  ...
  var dataReport = ReportDs().obs;
  HistoryDsController(this.idPerangkat);
  ...
  Future<void> fetchDataDaily(String date, String id,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dataReport.value = ReportDs.fromJson(jsonData);
      } else {
