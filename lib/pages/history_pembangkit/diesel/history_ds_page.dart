...
import 'package:manajemen_aset/pages/history_pembangkit/diesel/history_ds_controller.dart';

import '../../asset/aset_controller.dart';

class HistoryDsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HistoryDsController controller =
        Get.put(HistoryDsController(idPembangkit));
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.delete<HistoryDsController>();
    });
    return Column(
  ...
  Container showDatePicker(
      HistoryDsController controller, BuildContext context) {
    return Container(
      width: 230,
      height: 40,
