...
import 'history_sp_controller.dart';

class HistorySpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HistorySpController controller =
        Get.put(HistorySpController(idPembangkit));
                  ...
                  Obx(
                    () {
                      if (controller.isLoading.isTrue) {
                        ...
                        final reportSp = controller.reportSp.value;
                        return Column(
                          children: [
                            const SizedBox(height: 16),
                            ...
                            Table(
                              ...
                              children: [
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('Solar Rad'),
                                    rowTabel(reportSp.minSolarRad
                                        .toStringAsFixed(3)),
                                    rowTabel(reportSp.maxSolarRad
                                        .toStringAsFixed(3)),
                                    rowTabel(reportSp.avgSolarRad
                                        .toStringAsFixed(3)),
                                  ],
                                ),
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('Power (W)'),
                                    rowTabel(
                                        reportSp.minPower.toStringAsFixed(3)),
                                    rowTabel(
                                        reportSp.maxPower.toStringAsFixed(3)),
                                    rowTabel(
                                        reportSp.avgPower.toStringAsFixed(3)),
                                  ],
                                ),
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('Power kWh (kWh)'),
                                    rowTabel(
                                        reportSp.minProdKwh.toStringAsFixed(3)),
                                    rowTabel(
                                        reportSp.maxProdKwh.toStringAsFixed(3)),
                                    rowTabel(
                                        reportSp.avgProdKwh.toStringAsFixed(3)),
                                  ],
                                ),
                              ],
                            )
  ...
  Container showDatePicker(
      HistorySpController controller, BuildContext context) {
    return Container(
      width: 230,
      height: 40,
