...
import 'package:manajemen_aset/pages/history_pembangkit/baterai/history_bt_controller.dart';

import '../../asset/aset_controller.dart';

class HistoryBtPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HistoryBtController controller =
        Get.put(HistoryBtController(idPembangkit));
  ...
  Container showDatePicker(
      HistoryBtController controller, BuildContext context) {
    return Container(
      width: 230,
      height: 40,
