...
import '../../../models/report_rumahenergi.dart';
import '../../../network/base_url_controller.dart';

class HistoryRumahEnergiC extends GetxController
  ...
  var dataReport = ReportRumahEnergi().obs;
  HistoryRumahEnergiC(this.idPerangkat);
  ...
  Future<void> fetchDataDaily(String date, String id,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dataReport.value = ReportRumahEnergi.fromJson(jsonData);
      } else {
