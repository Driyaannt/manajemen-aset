...
class HistoryWtController extends GetxController
  ...
  var dataReport = ReportWt().obs;
  HistoryWtController(this.idPerangkat);
  ...
  Future<void> fetchDataDaily(String date, String id,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        dataReport.value = ReportWt.fromJson(jsonData);
      } else {
