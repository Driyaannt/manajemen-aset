...
import 'package:manajemen_aset/pages/history_pembangkit/wind_turbine/history_wt_controller.dart';

import '../../asset/aset_controller.dart';

class HistoryWtPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HistoryWtController controller =
        Get.put(HistoryWtController(idPembangkit));
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.delete<HistoryWtController>();
    });
    return Column(
                          ...
                          children: [
                            ...
                            Table(
                              ...
                              children: [
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('RPM Generator \n(rpm)'),
                                    rowTabel(controller
                                        .dataReport.value.minRpmGenerator
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.maxRpmGenerator
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.avgRpmGenerator
                                        .toString()),
                                  ],
                                ),
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('RPM Bilah \n(rpm)'),
                                    rowTabel(controller
                                        .dataReport.value.minRpmBilah
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.maxRpmBilah
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.avgRpmBilah
                                        .toString()),
                                  ],
                                ),
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('Prod kwh \n(kWh)'),
                                    rowTabel(controller
                                        .dataReport.value.minProdKwh
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.maxProdKwh
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.avgProdKwh
                                        .toString()),
                                  ],
                                ),
                                ...
                                TableRow(
                                  children: [
                                    rowTabel('Wind Sped \n(m/s)'),
                                    rowTabel(controller
                                        .dataReport.value.minWindSpeed
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.maxWindSpeed
                                        .toString()),
                                    rowTabel(controller
                                        .dataReport.value.avgWindSpeed
                                        .toString()),
                                  ],
                                ),
                              ],
  ...
  Container showDatePicker(
      HistoryWtController controller, BuildContext context) {
    return Container(
      width: 230,
      height: 40,
